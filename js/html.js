        ...
        productos.forEach(producto => {
            ...
            <img src="${producto.getImagen()}" class="imagen-curso u-full-width">
                    ...
                    <div data-item="${producto.getId()}" class="btnBorrarProducto">
                        <a href="#" class="u-full-width button-primary button input ver-pedido" id="btn-borrar" >Borrar producto</a>
                    </div>
    ...
    static mostrarPedidoCliente(pedidos, id) {
        pedidos.forEach(pedido => {
            ...
            if (idPedido == id) {
                ...
                precio.innerHTML = `
                <p class="text-center">Precio final: ${precioTotal}€</p>
                <div data-item="${idCancelar}" class="btnCancelarPedido">
